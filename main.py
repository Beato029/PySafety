...
import numpy as np
import cv2
# Per aggiornamento della condivisione vedere chatgpt
...
class UI:
    def __init__(self):
        ...
        print(green + 'versione: ' + VERSIONE[0], green + str(VERSIONE[1]))
        print(red + '=' * 45)
...
class Server:
        ...
        while True:
            ...
            match command:
                ...
                case 'help':
                    ...
                    print('\tscreenmirror *     -> Visualizza lo schermo del client')
    ...
    def Recv(self, options=''):
        ...
        match options:
            ...
            case 'screenmirror':
                while True:
                    # Riceve la lunghezza dell'immagine
                    msg_size_data = self.conn.recv(4)
                    if not msg_size_data:
                        break
                    msg_len = struct.unpack('>L', msg_size_data)[0]

                    # Riceve i dati immagine
                    data = b''
                    ...
                    if frame is not None:
                        cv2.imshow('Server - Schermo remoto', frame)
...
def check_update():
    ...
    if update:
        ...
        if download in ['yes', 'y']:
            os.system('sudo python update.py')
        else:
            pass
